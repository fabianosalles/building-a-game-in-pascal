...
begin
  ...
  case fState of
    stLogoAeonsoft: begin
      ...
      engine.Text.Draw('aeonsoft', dest.x - 40, dest.y + dest.h, engine.Fonts.GUILarge, fAlpha);
    ...
    stLogoLazarus: begin
      ...
      SDL_SetRenderDrawBlendMode(renderer, SDL_BLENDMODE_BLEND);
      SDL_RenderCopy(renderer, tex.Data, @source, @dest);
      engine.Text.Draw('LAZARUS', dest.x - 80, dest.y + dest.h + 60, engine.Fonts.GUILarge, fAlpha);
